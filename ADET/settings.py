"""
Django settings for ADET project.
...
CSRF_TRUSTED_ORIGINS= ["https://adet-project-production.up.railway.app"]
...
WSGI_APPLICATION = 'ADET.wsgi.application'
